export const projects = [
  ...
  },
  {
    ...
    description_long: 'In this Pokémon gallery you can find all the Pokémon or search them by name or their index. It uses the Pokeapi.',
  ...
  },
  {
    ...
    description_long: 'A card game which can be played with multiple persons online. This game is built with TypeScript and Angular.',
